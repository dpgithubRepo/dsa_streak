...
/**
 * Problem Description Given an array A of N integers. Also given are two
 ...
 * 
 * 
 * Input Format The first argument A is an array of integer. The second and
 * third arguments are integers B and C
 * 
 * 
...
public class ReverseInRange {
	 ...
	 static ArrayList<Integer> solve(ArrayList<Integer> A, int B, int C) {
	 ...
	 public static void main(String[] args) {
		...
		System.out.println(solve(a,2,3));
		
		a = new ArrayList<>();
		a.add(1);a.add(2);a.add(3);a.add(4);
		System.out.println(solve(a,0,3));
	}
}
